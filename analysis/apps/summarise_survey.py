...
SCALES = [
    {
        ...
        "max_value": 10,
        "items": [
            {"column": "cl_ch1_scores_1", "statement": "The appearances of the creatures covered in this chapter were complex.", "reverse": False},
            {"column": "cl_ch1_scores_2", "statement": "The facts about the creatures covered in this chapter were complex.", "reverse": False},
            {"column": "cl_ch1_scores_3", "statement": "The creatures covered in this chapter were difficult to tell apart.", "reverse": False},
            {"column": "cl_ch1_scores_4", "statement": "The elements in this chapter's game world made the learning unclear.", "reverse": False},
            {"column": "cl_ch1_scores_5", "statement": "This chapter's game world was, in terms of learning, ineffective.", "reverse": False},
    ...
    },
    {
        ...
        "max_value": 10,
        "items": [
            {"column": "cl_ch2_scores_1", "statement": "The appearances of the creatures covered in this chapter were complex.", "reverse": False},
            {"column": "cl_ch2_scores_2", "statement": "The facts about the creatures covered in this chapter were complex.", "reverse": False},
            {"column": "cl_ch2_scores_3", "statement": "The creatures covered in this chapter were difficult to tell apart.", "reverse": False},
            {"column": "cl_ch2_scores_4", "statement": "The elements in this chapter's game world made the learning unclear.", "reverse": False},
            {"column": "cl_ch2_scores_5", "statement": "This chapter's game world was, in terms of learning, ineffective.", "reverse": False},
    ...
    },
    {
        ...
        "max_value": 10,
        "items": [
            {"column": "cl_ch3_scores_1", "statement": "The appearances of the creatures covered in this chapter were complex.", "reverse": False},
            {"column": "cl_ch3_scores_2", "statement": "The facts about the creatures covered in this chapter were complex.", "reverse": False},
            {"column": "cl_ch3_scores_3", "statement": "The creatures covered in this chapter were difficult to tell apart.", "reverse": False},
            {"column": "cl_ch3_scores_4", "statement": "The elements in this chapter's game world made the learning unclear.", "reverse": False},
            {"column": "cl_ch3_scores_5", "statement": "This chapter's game world was, in terms of learning, ineffective.", "reverse": False},
    ...
    },
    {
        ...
        "items": [
            ...
            {"column": "eng_ch1_scores_4", "statement": "This chapter was pleasurable to look at.", "reverse": False},
    ...
    },
    {
        ...
        "items": [
            ...
            {"column": "eng_ch2_scores_4", "statement": "This chapter was pleasurable to look at.", "reverse": False},
    ...
    },
    {
        ...
        "items": [
            ...
            {"column": "eng_ch3_scores_4", "statement": "This chapter was pleasurable to look at.", "reverse": False},
            {"column": "eng_ch3_scores_5", "statement": "I felt interested in this chapter.", "reverse": False},
        ],
    },
    {
        "id": "instruction_el_overall",
        "title": "Cognitive load | Overall | Instruction-related extraneous load",
        ...
        "interpretation": "Higher scores indicate higher instruction-related extraneous cognitive load after reverse-coding.",
        "min_value": 0,
        "max_value": 10,
        "items": [
            {"column": "cl_overall_scores_1", "statement": "The instructions about what I had to do in the game were clear.", "reverse": True},
            {"column": "cl_overall_scores_2", "statement": "The explanation of how the chapters and checkpoints worked was clear.", "reverse": True},
            {"column": "cl_overall_scores_3", "statement": "The instructions about finding and learning about creatures were, in terms of learning, effective.", "reverse": True},
        ],
    },
    {
        "id": "interaction_el_overall",
        "title": "Cognitive load | Overall | Interaction-related extraneous load",
        "section_title": "Overall experience (1/2)",
        "description": "Please answer the following questions about the game overall on a scale from 0 (= not at all the case) to 10 (= completely the case).",
        "interpretation": "Higher scores indicate higher interaction-related extraneous cognitive load after reverse-coding.",
        "min_value": 0,
        "max_value": 10,
        "items": [
            {"column": "cl_overall_scores_4", "statement": "The way I had to interact with the game was clear.", "reverse": True},
            {"column": "cl_overall_scores_5", "statement": "The way I had to interact with the game was, in terms of learning about the creatures, effective.", "reverse": True},
            {"column": "cl_overall_scores_6", "statement": "The way I had to interact with the game made it easier to learn about the creatures.", "reverse": True},
            {"column": "cl_overall_scores_7", "statement": "The way I had to interact with the game was easy to master.", "reverse": True},
        ],
    },
    {
        "id": "gl_overall",
        "title": "Cognitive load | Overall | Germane load",
        "section_title": "Overall experience (1/2)",
        "description": "Please answer the following questions about the game overall on a scale from 0 (= not at all the case) to 10 (= completely the case).",
        "interpretation": "Higher scores indicate higher germane cognitive load.",
        "min_value": 0,
        "max_value": 10,
        "items": [
            {"column": "cl_overall_scores_8", "statement": "The game really enhanced my understanding of the creatures covered.", "reverse": False},
            {"column": "cl_overall_scores_9", "statement": "The game helped me connect the creatures' appearances with their facts.", "reverse": False},
            {"column": "cl_overall_scores_10", "statement": "The game helped me organise the creature information in my mind.", "reverse": False},
            {"column": "cl_overall_scores_11", "statement": "The game helped me keep the different creatures apart.", "reverse": False},
        ],
    },
    {
        "id": "eng_overall",
